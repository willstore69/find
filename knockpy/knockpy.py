...
class Start():
    ...
    def arguments():
        ...
        description = "-"*80+"\n"
        description += "* SCAN\n"
        description += "full scan:\tingfo domain.com\n"
        description += "ignore code:\tingfo domain.com --no-http-code 404 500 530\n"
        description += "threads:\tingfo domain.com -th 50\n"
        description += "timeout:\tingfo domain.com -t 2\n\n"
        description += "* REPORT\n"
        description += "show report:\tingfo --report ingfo_report/domain.com_yyyy_mm_dd_hh_mm_ss.json\n"
        description += "plot report:\tingfo --plot ingfo_report/domain.com_yyyy_mm_dd_hh_mm_ss.json\n"
        description += "csv report:\tingfo --csv ingfo_report/domain.com_yyyy_mm_dd_hh_mm_ss.json\n\n"
        description += "* SETTINGS\n"
        description += "set apikey:\tingfo --set apikey-virustotal=APIKEY\n"
        description += "set timeout:\tingfo --set timeout=sec\n"
